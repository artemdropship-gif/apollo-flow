...
ВЫПОЛНЯЙ СТРОГО по рабочему стандарту и ТЗ ниже. По умолчанию СОХРАНЯЙ текущий
стек и архитектуру как есть — не переписывай и не добавляй лишнего.
Предлагай дополнения или замены в стеке/блоках ТОЛЬКО ЕСЛИ:
  • текущего стека объективно НЕ ХВАТАЕТ для описанных целей/требований, или
  • есть явно ЛУЧШИЙ вариант под эту задачу.
В таких случаях добавляй недостающее (по возможности — по дефолтному стеку
стандарта) и кратко поясняй причину в поле description соответствующего блока.
Можешь уточнить: цель, суть, страницы, дизайн-решения, блоки и связи — но без
избыточности.
